...
@section('top_page')
    <x-top-page title="فرم ویرایش کوپن" :items="['فروشگاه','فرم ویرایش کوپن']" homeUrl="/" />
@endsection
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form class="theme-form" action="{{ route('coupon.update',$coupon->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            {{-- کد کوپن --}}
                            <div class="mb-3">
                                <label for="code" class="col-form-label pt-0">کد کوپن <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="code" name="code" placeholder="مثال: SUMMER25" value="{{ old('code',$coupon->code) }}" required maxlength="20" pattern="[A-Za-z0-9]+" title="کد کوپن فقط شامل حروف و اعداد باشد">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control" id="type" name="type" required>
                                    <option value="" disabled {{ old('type',$coupon->type) ? '' : 'selected' }}>نوع تخفیف را انتخاب کنید</option>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="value" name="value" placeholder="مثال: 25.00 برای 25%" value="{{ old('value',$coupon->value) }}" required step="0.01" min="0">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="min_order_amount" name="min_order_amount" placeholder="مثال: 100000" value="{{ old('min_order_amount',$coupon->min_order_amount) }}" step="0.01" min="0">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="usage_limit" name="usage_limit" placeholder="مثال: 100" value="{{ old('usage_limit',$coupon->usage_limit) }}" min="1">
                                @error('usage_limit') <small class="text-danger">{{ $message }}</small> @enderror
                            </div>

                            <div class="form-group">
                                <label for="start_date">تاریخ شروع:</label>
                                <input type="text" id="start_date" name="start_date" class="form-control" value="{{ old('start_date',\Morilog\Jalali\Jalalian::fromDateTime($coupon->start_date)->format('Y/m/d H:i:s')) }}" readonly>
                            </div>

                            <div class="form-group">
                                <label for="end_date">تاریخ پایان:</label>
                                <input type="text" id="end_date" name="end_date" class="form-control" value="{{ old('end_date',\Morilog\Jalali\Jalalian::fromDateTime($coupon->end_date)->format('Y/m/d H:i:s')) }}" readonly>
                            </div>

{{--                            --}}{{-- تاریخ شروع --}}
{{--                            <div class="mb-3">--}}
{{--                                <label for="start_date" class="col-form-label pt-0">تاریخ شروع</label>--}}
{{--                                <input type="datetime-local" class="form-control" id="start_date" name="start_date" value="{{ old('start_date',$coupon->start_date) }}">--}}
...
{{--                                <input type="datetime-local" class="form-control" id="end_date" name="end_date" value="{{ old('end_date',$coupon->end_date) }}">--}}
