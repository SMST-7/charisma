...
@section('top_page')
    <x-top-page title="فرم ایجاد تخفیف ها" :items="['فروشگاه','فرم ایجاد تخفیف ها']" homeUrl="/" />
@endsection
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                            <form class="theme-form" action="{{ route('discount.store') }}" method="post">
                                @csrf
                                {{--فیلد جستجوی محصول--}}
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="discount_percentage" type="number"
                                           ...
                                           placeholder="درصد تخفیف را وارد کنید" value="{{ old('discount_percentage') }}"
                                           required>
                                ...
                                <div class="mb-3">
                                    <label class="col-form-label pt-0" for="is_active">وضعیت<span
                                            class="text-danger">*</span></label>
                                    <select class="form-select digits" id="is_active" name="is_active">
...
{{-- ============جستجو محصول===========--}}
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const options = Array.from(select.options); // همه گزینه‌ها را در آرایه نگه می‌داریم
            ...
            searchInput.addEventListener('input', function () {
                ...
                // فیلتر کردن بر اساس ورودی کاربر
                ...
                if (filtered.length === 0) {
                    ...
                    opt.text = 'هیچ محصولی یافت نشد';
                    select.add(opt);
                    return;
                }

                // افزودن نتایج فیلترشده
                filtered.forEach(opt => select.add(opt));
            });
        });
    </script>
