...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('panel/images/logo/favicon-icon.png') }}" type="image/x-icon">
    <title> @yield('title')</title>
    <link rel="stylesheet" type="text/css" href="{{ asset('panel/css/vendors/font-awesome.css') }}">
    <!-- ico-font-->
    <link rel="stylesheet" type="text/css" href="{{ asset('panel/css/vendors/icofont.css') }}">
    <!-- Themify icon-->
    <link rel="stylesheet" type="text/css" href="{{ asset('panel/css/vendors/themify.css') }}">
    <!-- Flag icon-->
    <link rel="stylesheet" type="text/css" href="{{ asset('panel/css/vendors/flag-icon.css') }}">
    <!-- Feather icon-->
    <link rel="stylesheet" type="text/css" href="{{ asset('panel/css/vendors/feather-icon.css') }}">
    <!-- Plugins css start-->
    <link rel="stylesheet" type="text/css" href="{{ asset('panel/css/vendors/scrollbar.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('panel/css/vendors/animate.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('panel/css/vendors/date-picker.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('panel/css/vendors/photoswipe.css') }}">
    <!-- Plugins css Ends-->
    <!-- Bootstrap css-->
    <link rel="stylesheet" type="text/css" href="{{ asset('panel/css/vendors/bootstrap.css') }}">
    <!-- App css-->
    <link rel="stylesheet" type="text/css" href="{{ asset('panel/css/style.css') }}">
    <link id="color" rel="stylesheet" href="{{ asset('panel/css/color-1.css') }}" media="screen">
    <!-- Responsive css-->
    <link rel="stylesheet" type="text/css" href="{{ asset('panel/css/responsive.css') }}">
{{--    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">--}}
    <link rel="stylesheet" href="{{ asset('panel/css/vendor/bootstrap.min.css') }}">


    {{--    <link rel="stylesheet" type="text/css" href="{{ asset('panel/css/banner/style.css') }}">--}}
</head>
    ...
    <div class="page-header">
        <div class="header-wrapper row m-0">
            <div class="header-logo-wrapper col-auto p-0">
                <div class="logo-wrapper"><a href="index.html"><img class="img-fluid" src="{{ asset('panel/images/logo/logo.png')}}"
                                                                    alt=""></a></div>
            ...
            <div class="nav-right col-10 col-sm-6 pull-right right-header p-0">
                <ul class="nav-menus">
                    ...
                    <li class="d-md-none resp-serch-input">
                        <div class="resp-serch-box"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-search"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg></div>
                        <div class="form-group search-form open">
                    ...
                    <li class="onhover-dropdown">
                        <div class="notification-box">
                            ...
                            <span class="badge rounded-pill badge-warning">{{ $logs->count() }}</span>
                        </div>

                        <div class="onhover-show-div notification-dropdown">
                            <div class="dropdown-title">
                                <h3>اعلان</h3>
                                <a class="f-right" href="#"><i data-feather="bell"></i></a>
                            </div>
                            <ul class="custom-scrollbar">
                                            ...
                                            <div class="media-body">
                                                <h5>
                                                    <a class="f-14 m-0" href="#">
                                                        {{ $log->user ? $log->user->username : 'کاربر ناشناس' }}
                                                    </a>
                                                </h5>
                                                <p>{{ $log->description }}</p>
                                ...
                                @empty
                                    <li>
                                        <p class="text-center">هیچ لاگی موجود نیست</p>
                                    </li>
                                @endforelse

                                <li class="p-0">
                                    <a class="btn btn-primary" href="{{ route('logs.index') }}">بررسی همه</a>
                                </li>
                            </ul>
                        </div>
...
{{--                        <div class="onhover-show-div notification-dropdown">--}}
{{--                            <div class="dropdown-title">--}}
{{--                                <h3>اعلان</h3><a class="f-right" href="#"> <i data-feather="bell"> </i></a>--}}
{{--                            </div>--}}
{{--                            <ul class="custom-scrollbar">--}}
{{--                                <li>--}}
{{--                                    <div class="media">--}}
{{--                                        <div class="notification-img bg-light-primary"><img src="" alt="">--}}
{{--                                        </div>--}}
{{--                                        <div class="media-body">--}}
{{--                                            <h5> <a class="f-14 m-0" href="user-profile.html"> </a></h5>--}}
...
{{--                        </div>--}}
                    ...
                    <li class="profile-nav onhover-dropdown pe-0 py-0 me-0">
                        ...
                        <ul class="profile-dropdown onhover-show-div">
                            <li><a href="{{route('profile.edit')}}"><i data-feather="user"></i><span>حساب کاربری </span></a></li>
            ...
            <script class="result-template" type="text/x-handlebars-template">
                <div class="ProfileCard u-cf">
                    ...
                    <div class="ProfileCard-details">
                        <div class="ProfileCard-realName">someone</div>
                    </div>
                </div>
            </script>
